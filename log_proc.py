...
delta_t_prof = ['prof_time_original', 0]
...
for data in original_data:
    ...
    delta_t_prof.append(data['delta_t_prof'])
...
delta_t_prof = ['prof_time_pruned', 0]
delta_t_computations = ['', '']
...
# draw chart
time_original = Reference(ws, min_col=1, min_row=4, max_col=20)
time_pruned = Reference(ws, min_col=1, min_row=14, max_col=20)
bandwidth_original = Reference(ws, min_col=1, min_row=6, max_col=20)
bandwidth_pruned = Reference(ws, min_col=1, min_row=16, max_col=20)
# line chart for time
c1 = LineChart()
